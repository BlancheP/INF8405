...
public class MapFragment extends Fragment implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mLocationRequest = LocationRequest.create()
                ...
                .setInterval(5000)        // 20 seconds, in milliseconds; frequency that we want location updates - faster updates = more power!
                .setFastestInterval(5000); // 10 second, in milliseconds; if a location is available sooner we can get it without extra power (i.e. another app is using the location services)
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        //TODO: @Blanche, necessary in this project?
        /*
