...
public class NetworkActivity extends AppCompatActivity {
    ...
    public static String currentNetworkPreference = null;
    ...
    //
    //the app checks the preferences settings in onStart().
    ...
    // the app then perform a given action that requires Wi-Fi
    ...
    public void onStart () {
        ...
        currentNetworkPreference = sharedPrefs.getString("listPref", "Wi-Fi");
